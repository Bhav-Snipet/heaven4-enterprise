...
import { ShoppingBag, Plus, Leaf, Sparkles, AlertCircle, Ticket, Key, ChevronRight } from 'lucide-react';
            ...
            <main className="p-4 md:p-8 max-w-7xl mx-auto space-y-6">
                ...
                <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}
                    ...
                    <div className="flex items-center gap-2 w-full md:w-auto justify-end">
                        ...
                        <button
                            onClick={() => navigate('/customer/events')}
                            className="px-3.5 py-2.5 bg-purple-600/30 hover:bg-purple-600/50 text-purple-200 border border-purple-500/40 font-bold text-xs rounded-xl flex items-center gap-1.5 transition-all shrink-0"
                        >
                            <Key className="w-3.5 h-3.5" /> Unlock Private Code
                        </button>
                    </div>
                </motion.div>
                {error && (
